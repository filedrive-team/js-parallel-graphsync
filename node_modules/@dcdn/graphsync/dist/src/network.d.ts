...
export declare type Network = ProtocolDialer & ProtocolHandlerRegistrar & PeerAddressRegistrar;
export interface ProtocolDialer {
    dialProtocol: (peer: PeerId, protocols: string[] | string, options?: any) => Promise<{
        stream: MuxedStream;
        protocol: string;
    }>;
}
